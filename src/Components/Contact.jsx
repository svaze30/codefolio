  ...
  return (
    ...
    >
      ...
      <div className="all-contact flex flex-col items-center justify-center border-0 border-slate-950">
        ...
        <h2 className=" flex justify-center w-full border border-slate-950 border-dashed text-2xl p-4">
        ...
        <div className="flex w-full justify-around m-4">
          ...
          <a
            className="flex flex-col justify-center items-center text-center"
            href="https://www.linkedin.com/in/swaroop-vaze-aa41b82b1/"
            target="_blank"
          >
            Linked In{""}
            <svg
          ...
          <a
            className="flex flex-col justify-center items-center text-center"
            href="https://www.instagram.com/svaze30/"
            target="_blank"
          >
            Instagram{""}
            <svg
